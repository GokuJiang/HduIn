...
//    public func colors(scaleDownSize: CGSize? = nil) ->(
//        background: UIColor,
//        primary: UIColor,
//        secondary: UIColor,
//        detail: UIColor
...
//            cgImage = resize(newSize: scaleDownSize).cgImage!
//        } else {
//            let ratio = size.width / size.height
//            let r_width: CGFloat = 250
//            cgImage = resize(newSize: CGSize(width: r_width, height: r_width / ratio)).cgImage!
//        }
//
...
//            data: raw, width: width, height: height, bitsPerComponent: bitsPerComponent, bytesPerRow: bytesPerRow, space: colorSpace, bitmapInfo: bitmapInfo
//        )
...
//            where CGFloat(countedColor.count / proposedEdgeColor.count) > 0.3 {
...
//
//            if primaryColor == nil &&
//            color.isContrastingWith(color: imageBackgroundColor) {
//                primaryColor = color
//            } else if secondaryColor == nil &&
//            primaryColor != nil &&
//            primaryColor!.isDistinctFrom(color: color) &&
//            color.isContrastingWith(imageBackgroundColor) {
//                secondaryColor = color
//            } else if secondaryColor != nil &&
//            (secondaryColor!.isDistinctFrom(color: color) &&
